  ...
  <div class="container-fluid m-0 p-0">
      ...
      <div class="row">
        <div class="col-lg">
          ...
          <h5 class="ml-md-4 mr-md-4">
            Plan your next adventure by setting a daily spending budget. We make
            it easy to break your expenses down by category, giving you more
            time to plan the important things!
          </h5>
        </div>
        <div class="col-lg">
    ...
    <div id="footer" class="p-4">
      <footer class="text-light p-4">
        <a
          href="https://www.youtube.com.br/1manstartup"
          target="_blank"
          class="text-warning"
          >Build This App</a
        >
        ...
        <br />
        <small>&copy; 2021, TravelTreasury.app</small>
      </footer>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    async addEmail(email) {
      ...
      await Auth.createUserWithEmailAndPassword(email, this.randomPassword(20)).
    ...
    sendContactMessage() {
      if (!this.validEmail(this.contact_email)) {
        ...
        const url = `https://us-central1-travel-treasury-landing-a5931.cloudfunctions.net/sendEmail?email_from=${this.contact_email}&message=${this.contact_message}`
